    ...
    >
        ...
        <Stack margin={1} spacing={1}>
          {isDesktop ? (
            <>
              ...
              >
                {isDirectionDeposit ? "To" : "From"}
              </Typography>
              <Tooltip title={rollupmap.get(rollupType)}>
      ...
      <Grid xs={12} sm={10} item>
        {isDirectionDeposit && !handleL2Transfer ? (
          <div style={isDesktop ? { height: "70px" } : { height: "0" }}></div>
        ) : isDirectionDeposit && handleL2Transfer ? (
          <TextField
            ...
            onChange={(e) =>
              setUserAddress!(e.target.value ? e.target.value.trim() : "")
            }
          />
        ) : (
          ""
        ...
        <Stack
          direction={"column"}
          spacing={1}
          style={isDesktop ? { textAlign: "initial" } : { textAlign: "center" }}
        >
          {rollup instanceof RollupTORU ? (
            <TableContainer component={Paper}>
              <Table>
                <TableBody>
                  <TableRow>
                    <TableCell>commitment_newest_hash </TableCell>
                    <TableCell>{rollup.commitment_newest_hash}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>finalized_commitments </TableCell>
                    <TableCell>{rollup.finalized_commitments.next}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>last_removed_commitment_hashes </TableCell>
                    <TableCell>
                      {rollup.last_removed_commitment_hashes}
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>inbox_ema</TableCell>
                    <TableCell>{rollup.inbox_ema}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>tezos_head_level </TableCell>
                    <TableCell>{rollup.tezos_head_level}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>allocated_storage </TableCell>
                    <TableCell>{rollup.allocated_storage}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>uncommitted_inboxes </TableCell>
                    <TableCell>{rollup.uncommitted_inboxes.next}</TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell>unfinalized_commitments </TableCell>
                    <TableCell>{rollup.unfinalized_commitments.next}</TableCell>
                  </TableRow>
                </TableBody>
              </Table>
            </TableContainer>
                ...
                <AccordionDetails>
                  <TableContainer component={Paper}>
                    <Table>
                      <TableBody>
                        <TableRow>
                          <TableCell>rollup_level </TableCell>
                          <TableCell>
                            {rollup.rollup_level.toNumber()}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>messages </TableCell>
                          <TableCell>{rollup.messages.toJSON()}</TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>fixed_ticket_key.mint_address </TableCell>
                          <TableCell>
                            {rollup.fixed_ticket_key.mint_address}
                          </TableCell>
                        </TableRow>
                        <TableRow>
                          <TableCell>fixed_ticket_key.payload</TableCell>
                          <TableCell>
                            {rollup.fixed_ticket_key.payload}
                          </TableCell>
                        </TableRow>
                      </TableBody>
                    </Table>
